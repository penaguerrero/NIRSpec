...
stars_detectors = range(1, 101)

# prepare lists to append total resutls
diffV2_3, diffV3_3, diffV2_5, diffV3_5, diffV2_7, diffV3_7 = [], [], [], [], [], []
tot_diffV2_3, tot_diffV3_3, tot_diffV2_5, tot_diffV3_5, tot_diffV2_7, tot_diffV3_7 = [], [], [], [], [], []
LS_V2_sigmas_3, LS_V3_sigmas_3 = [], []
LS_V2_sigmas_5, LS_V3_sigmas_5 = [], []
LS_V2_sigmas_7, LS_V3_sigmas_7 = [], []
LS_V2_deltas_3, LS_V3_deltas_3 = [], []
LS_V2_deltas_5, LS_V3_deltas_5 = [], []
LS_V2_deltas_7, LS_V3_deltas_7 = [], []
...
for n in range(Nktimes):
    ...
    # Append results to total variables
    diffV2_3.append(T_diffVs[0])
    diffV3_3.append(T_diffVs[1])
    diffV2_5.append(T_diffVs[2])
    diffV3_5.append(T_diffVs[3])
    diffV2_7.append(T_diffVs[4])
    diffV3_7.append(T_diffVs[5])
    LS_V2_sigmas_3.append(LS_res[0][0])
    LS_V3_sigmas_3.append(LS_res[0][0])
    LS_V2_sigmas_5.append(LS_res[1][0])
    LS_V3_sigmas_5.append(LS_res[1][1])
    LS_V2_sigmas_7.append(LS_res[2][0])
    LS_V3_sigmas_7.append(LS_res[2][1])
    LS_V2_deltas_3.append(LS_res[3][0])
    LS_V3_deltas_3.append(LS_res[3][1])
    LS_V2_deltas_5.append(LS_res[4][0])
    LS_V3_deltas_5.append(LS_res[4][1])
    LS_V2_deltas_7.append(LS_res[5][0])
    LS_V3_deltas_7.append(LS_res[5][1])


# Compact results
print (diffV2_3)
for i, _ in enumerate(diffV2_3):
    for j, _ in enumerate(diffV2_3[i]):
        tot_diffV2_3.append(diffV2_3[i][j])
        tot_diffV3_3.append(diffV3_3[i][j])
        tot_diffV2_5.append(diffV2_5[i][j])
        tot_diffV3_5.append(diffV3_5[i][j])
        tot_diffV2_7.append(diffV2_7[i][j])
        tot_diffV3_7.append(diffV3_7[i][j])
LSsigmas_3 = [LS_V2_sigmas_3, LS_V3_sigmas_3]
LSsigmas_5 = [LS_V2_sigmas_5, LS_V3_sigmas_5]
LSsigmas_7 = [LS_V2_sigmas_7, LS_V3_sigmas_7]
LSdeltas_3 = [LS_V2_deltas_3, LS_V3_deltas_3]
LSdeltas_5 = [LS_V2_deltas_3, LS_V3_deltas_3]
LSdeltas_7 = [LS_V2_deltas_3, LS_V3_deltas_3]
T_diffVs_tot = [tot_diffV2_3, tot_diffV3_3, tot_diffV2_5, tot_diffV3_5, tot_diffV2_7, tot_diffV3_7]
LS_res_tot = [LSsigmas_3, LSsigmas_5, LSsigmas_7, LSdeltas_3, LSdeltas_5, LSdeltas_7]


print ("\n Script 'XrandStarsNktimes.py' finished! Took  %s  seconds to finish. \n" % (time.time() - start_time))

# calculate true standard deviation and mean for plot
v2v3plots.make_v2v3plots(case, T_diffVs_tot, LS_res_tot,
                         save_plot=True, show_plot=False, destination=None)
