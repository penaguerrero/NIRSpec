...
def flattest(step_input_filename, dflatref_path=None, sfile_path=None, fflat_path=None, writefile=None,
    ...
    Args:
        ...
        writefile: string, base name for the calculated flat and difference images
...
if __name__ == '__main__':
    ...
    median_diff = flattest(step_input_filename, dflatref_path=dflatref_path, sfile_path=sfile_path,
                           fflat_path=fflat_path, writefile=None,
