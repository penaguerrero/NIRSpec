...
# WCS parameters
keywd_dict['WCSAXES'] = [int] # number of World Coordinate System axes, e.g. 3
keywd_dict['CRPIX1']  = [int, float] # x-coordinate of the reference pixel, e.g. 1024.0
keywd_dict['CRPIX2']  = [int, float] # y-coordinate of the reference pixel, e.g. 128.0
keywd_dict['CRVAL1']  = [float] # RA at the reference pixel (degrees), 5.3196
keywd_dict['CRVAL2']  = [float] # Dec at the reference pixel (degrees), e.g. -72.98605000000001
keywd_dict['CRVAL3']  = [float] # Wavelength at the reference pixel (microns), e.g. 2.5
keywd_dict['CTYPE1']  = ['RA---TAN'] # first axis coordinate type
keywd_dict['CTYPE2']  = ['DEC--TAN'] # second axis coordinate type
keywd_dict['CTYPE3']  = [str] # third axis coordinate type, e.g. WAVE
...
keywd_dict['CDELT1']  = [float] # increment per pixel, axis 1, e.g. 0.12
keywd_dict['CDELT2']  = [float] # increment per pixel, axis 2, e.g. 0.12
keywd_dict['CDELT3']  = [float] # increment per pixel, axis 3, e.g. 0.000672
keywd_dict['PC1_1']   = [float] # linear transformation matrix element, e.g. 1.0
keywd_dict['PC1_2']   = [float] # linear transformation matrix element, e.g. 0.0
keywd_dict['PC2_1']   = [float] # linear transformation matrix element, e.g. 0.0
keywd_dict['PC2_2']   = [float] # linear transformation matrix element, e.g. 1.0
keywd_dict['PC3_1']   = [float] # linear transformation matrix element, e.g. 1.0
keywd_dict['PC3_2']   = [float] # linear transformation matrix element, e.g. 0.0
keywd_dict['S_REGION']= [str] # spatial extent of the observation, e.g. 'N/A'
# additional keywords needed in intput to level 2b -> email from Howard Nov 3 2016
keywd_dict['V2_REF']  = [float] # location of the aperture reference point in V2 (arcsec): 100-400 arcsec
keywd_dict['V3_REF']  = [float] # location of the aperture reference point in V3 (arcsec): -100 to -400 arcsec
keywd_dict['RA_REF']  = [float] # RA at the reference point (deg): 0 < RA < 360
keywd_dict['DEC_REF'] = [float] # Dec at the reference point (deg): -90 < Dec < +90
keywd_dict['ROLL_REF']= [float] # Roll angle at the reference point (deg), e.g. 5.3196
